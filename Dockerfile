...
RUN native-image -jar /tmp/build/build/libs/aemterliste2-all-1.0-SNAPSHOT.jar -H:ReflectionConfigurationFiles=reflection.json -H:Name=aemterliste2 -H:+JNI --static -H:EnableURLProtocols=http,https --enable-all-security-services && ls -la /tmp/build
